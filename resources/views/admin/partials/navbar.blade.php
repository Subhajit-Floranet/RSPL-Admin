        ...
        <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="index.html">
                ...
                <b class="logo-icon p-l-10">
                    ...
                    <!-- Dark Logo icon -->
                    {{-- <img src="{{ asset('images/logo-1.jpg') }}" alt="homepage" class="light-logo" style="width: 100%; opacity: 0.7;" /> --}}
                    RSPL ADMIN PANEL
                </b>
                <!--End Logo icon -->
                 <!-- Logo text -->
                {{-- <span class="logo-text">
                     <!-- dark Logo text -->
                     <img src="{{ asset('images/I3_Access.jpg') }}" alt="homepage" class="light-logo" />
