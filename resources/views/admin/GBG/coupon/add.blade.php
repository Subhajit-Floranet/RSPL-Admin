...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">{{ strtoupper($websiteShortCode) }} Create Coupon</h4>
        ...
        <div class="col-12">
            <div class="card">
                @foreach (['danger', 'warning', 'success', 'info'] as $msg)
                    ...
                    @endif
                @endforeach
                <form action="{{route('admin.'.$websiteShortCode.'.coupon.add')}}" method="POST" class="form-horizontal" id="formadd" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group m-t-20">
                            ...
                            <span><input type="radio" name="discount_type" class="discount_type" value="F" checked>Flat</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <span><input type="radio" name="discount_type" class="discount_type" value="P">Percent</span>
                        </div>
                        ...
                        <div class="form-group m-t-20">
                            ...
                            <input type="datetime-local" class="form-control" id="start_date" name="start_date" placeholder="Start Date" required>
                        </div>
                        ...
                        <div class="form-group m-t-20">
                            ...
                            <input type="text" class="form-control" id="minimum_cart_amount" name="minimum_cart_amount" placeholder="Amount" required>
                        </div>
                    </div>
