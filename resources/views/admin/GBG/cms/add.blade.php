        ...
        <div class="col-12">
            <div class="card">
                @foreach (['danger', 'warning', 'success', 'info'] as $msg)
                    ...
                    @endif
                @endforeach
                <form action="{{route('admin.'.$websiteShortCode.'.cms.add')}}" method="POST" class="form-horizontal" id="formadd"  >
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group m-t-20">
                            <label>Content</label>
                            <textarea class="form-control" rows="5" id="postcontent" name="content" placeholder="Enter Content" required></textarea>
                        </div>
                        <div class="form-group m-t-20">
                            <label>Slug</label>
