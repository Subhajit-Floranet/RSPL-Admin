        ...
        <div class="col-12">
            <div class="card">
                @foreach (['danger', 'warning', 'success', 'info'] as $msg)
                    ...
                    @endif
                @endforeach
                <form action="{{route('admin.'.$websiteShortCode.'.testimonialmanagement.edit',[base64_encode($dataDetails->id)])}}" method="POST" class="form-horizontal" id="formadd"  >
                    @csrf
                    <div class="card-body">
                        <h4 class="card-title">TestimonialManagement Edit</h4>
